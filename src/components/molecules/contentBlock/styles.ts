...
import StyledContentBlockProps from './types'

export const StyledContentBlock = styled.div<StyledContentBlockProps>`
  ...
  h1 {
    ...
    font-style: ${props => props.$h1FontStyle || "unset"};
  ...
  h2 {
    ...
    font-style: ${props => props.$h2FontStyle || "unset"};
  ...
  h3 {
    ...
    font-style: ${props => props.$h3FontStyle || "unset"};
  ...
  h4 {
    ...
    font-style: ${props => props.$h4FontStyle || "unset"};
  ...
  a {
    ...
    text-decoration: ${props => props.$aTextDecoration || "none"};
